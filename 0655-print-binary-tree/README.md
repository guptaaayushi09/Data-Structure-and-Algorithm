<h2><a href="https://leetcode.com/problems/print-binary-tree/description/?envType=company&envId=amazon&favoriteSlug=amazon-all">655. Print Binary Tree</a></h2><h3>Medium</h3><hr><p>Given the <code>root</code> of a binary tree, construct a <strong>0-indexed</strong> <code>m x n</code> string matrix <code>res</code> that represents a <strong>formatted layout</strong> of the tree. The formatted layout matrix should be constructed using the following rules:</p>
